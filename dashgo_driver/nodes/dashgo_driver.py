...
class BaseController:
        ...
        if now > self.t_next:
            ...
            if (self.useSonar == True) :
                try:
                    ...
                    #rospy.loginfo("r0: " + str(r0) + " r1: " + str(r1))
                    sonar0_range = Range()
                ...
                try:
                    ...
                    #rospy.loginfo("r2: " + str(r0) + " r3: " + str(r1))
                    sonar2_range = Range()
    ...
    def cmdVelCallback(self, req):
        ...
        if (self.useSonar == True) :
            if((self.sonar_r0<=self.safe_range_0 and self.sonar_r0>=2)or(self.sonar_r1<=self.safe_range_0 and self.sonar_r1>=2)) and (x>0):
                x= 0.0
                rospy.logwarn("smaller than safe_range_0")
            elif((self.sonar_r0<=self.safe_range_1 and self.sonar_r0>=2)or(self.sonar_r1<=self.safe_range_1 and self.sonar_r1>=2)) and (x>0.15):
                x=0.15
                rospy.logwarn("smaller than safe_range_1")

            if((self.sonar_r2<=self.safe_range_0 and self.sonar_r2>=2)) and (th>0):
                th= 0.0
            ...
            if((self.sonar_r4<=self.safe_range_0 and self.sonar_r4>=2)and (x<0)):
                x=0
                rospy.logwarn("sonar_r4 smaller than safe_range_0, backward")
